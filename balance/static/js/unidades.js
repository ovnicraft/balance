jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		//datatype: "local",
        defaults: {
            emptyrecords: "No hay registros para mostrarse",
            loadtext: "Cargando..."
        },
		url:'cargar_unidades/',
        altRows: true,
		datatype: "json",
		height: 280,
		colNames: [' ', 'Nombre', 'Abreviatura'],
		colModel: [
			{name: 'myac',
             index: '', width: 80, fixed: true, sortable: false, resize: false,
			 formatter:'actions', 
			 formatoptions:{ 
				 keys:true,
				 delOptions:{recreateForm: true, beforeShowForm: beforeDeleteCallback, delData: {selrow: getSelectedRow}}
		...
		editurl: "editar_unidades/",//nothing is saved
